<?php global $cards_count; ?>
<!-- == CARDS TASK MODAL ===================================== -->
<div class="remodal" data-remodal-id="cards-modal-<?php echo $cards_count; ?>" role="dialog">
  ...
  <div class="remodal-content">
    <table class="gmg-table">
      ...
      <tbody>
      <?php
          $task_post_id = intval($cards_entry['challenge_entry_assign_task'][1]);
